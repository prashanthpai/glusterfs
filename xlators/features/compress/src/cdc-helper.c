...
/* This is not used. Currently, the buffer size is fixed.*/
static int32_t
cdc_compute_buffer_size(int data_size)
{
        /* The WORST CASE choice of zlib parameters can result in an expansion
         * of at most 13.5%, plus eleven bytes. */
        return ( (int) (data_size * 1.135 + 11 + 8) );
}
